...
function elevar(num, exponent) {
  ...
  // Tu código:
  var nuevoValor = Math.pow (num,exponent);
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  var nuevaFrase = nombre + " " + apellido;
